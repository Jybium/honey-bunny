      ...
      <div className=" lg:grid grid-cols-2 flex items-center px-[4%] md:px-[20%] lg:px-[4%]  2xl:px-[6%]  py-[50px] ">
        ...
        <div className="w-full xl:w-[565px] mx-auto">
          <div className="bg-white md:rounded-t-[32px] rounded-t-[24px]  p-[4%] md:p-[32px] shadow-xl">
            ...
            <h4 className="text-[18px] md:text-[24px] font-[500] leading-[22px] mt-[30px] text-[#44464A] md:leading-[30px] md:w-[80%]">
            ...
            <form className="mt-[20px] md:mt-[50px]">
              ...
              <button className="bg-tertiary w-full px-[20px] py-[12px] rounded-[32px] mt-[20px] md:mt-[80px] text-black text-[16px] md:text-[18px] font-[400] hover:bg-tertiaryHover">
                Log in
              </button>
          ...
          <div className="p-[4%] md:p-[32px] bg-white rounded-b-[24px] mt-[4px] h-[58px] md:h-[71px] flex items-center justify-center">
