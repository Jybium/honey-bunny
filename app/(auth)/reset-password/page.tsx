...
const Page= () => {
  ...
  return (
    <div className=" xl:grid grid-cols-2 flex items-center px-[4%] md:px-[10%] lg:px-[4%]  2xl:px-[6%]  py-[50px] md:py-[50px] h-full">
      <div className="w-full md:w-[565px] mx-auto h-full">
        <div className="bg-white md:rounded-[32px] rounded-[24px]  p-[4%] md:p-[32px] md:pt-[20px] shadow-xl h-full flex flex-col">
          ...
          <div className="mt-auto">
            <button
              className={`w-full px-[20px] py-[12px] rounded-[32px] mt-[30px] md:mt-[80px] text-black text-[16px] md:text-[18px] font-[400] ${
                isSubmitDisabled
